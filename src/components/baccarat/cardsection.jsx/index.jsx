         ...
         <div className="cardsection">
           <div className="card_wrapper">
                <div className="card_side_a">                 
                   ...
                   <div className={this.props.sideACard1 ? "card1 active playcard" : 'card1 playcard'}>
                     <div className="cardfront">
                         <img src={this.props.sideA.card1} alt="card1"/>
                      </div>
                      {cardBack}
                       </div>
                      <div className={this.props.sideACard2 ? "card2 active playcard" : 'card2 playcard'}>
                      <div className="cardfront">
                        <img src={this.props.sideA.card2} alt="card2"/>
                      </div>
                      {cardBack}
                      </div>
                      <div className={this.props.sideACard3 ? "card3 active playcard" : 'card3 playcard'}>
                     <div className="cardfront">
                ...
                <div className="card_side_b">              
                   ...
                   <div className={this.props.sideBCard1 ? "card1 active playcard" : 'card1 playcard'}>
                      <div className="cardfront">
                      ...
                      <div className={this.props.sideBCard2 ? "card2 active playcard" : 'card2 playcard'}>
                      <div className="cardfront">
                         <img src={this.props.sideB.card2} alt="card2"/>
                      </div>
                      {cardBack}
                         </div>
                         <div className={this.props.sideBCard3 ? "card3 active playcard" : 'card3 playcard'}>
                      <div className="cardfront">
